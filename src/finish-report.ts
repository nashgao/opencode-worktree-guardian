...
export function withFinishReport(result: LooseRecord, preflight: FinishPreflight, reportDetails: LooseRecord = {}): GuardianFinishResult {
  ...
  return {
    ...
    report: {
      ...
      baseAuthorityRef: preflightSnapshot.baseAuthorityRef,
      baseRefOid: preflightSnapshot.baseRefOid,
      baseIsAncestorOfHead: preflightSnapshot.baseIsAncestorOfHead,
      headIsAncestorOfBase: preflightSnapshot.headIsAncestorOfBase,
