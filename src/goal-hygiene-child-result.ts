...
const SUMMARY_NUMBER_KEYS = ["candidateCount", "findingCount", "exclusionCount", "reviewableCandidateCount", "reviewableShownCount", "reviewableOmittedCount", "reviewableTotalFileCount", "approvedTargetCount", "blockedTargetCount", "fatalBlockerCount", "removedTargetCount"] as const;
const SUMMARY_BOOLEAN_KEYS = ["reviewableTruncated", "scanFailed"] as const;
