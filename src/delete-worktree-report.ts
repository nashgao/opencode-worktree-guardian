...
export function withDeleteReport(result: Record<string, unknown>, preflight: Record<string, unknown>, reportDetails: Record<string, unknown> = {}) {
  ...
  return {
    ...
    report: {
      ...
      allowRedundantDirtyPaths: preflightSnapshot.allowRedundantDirtyPaths,
      archivePath: preflightSnapshot.archivePath,
      archiveSha256: preflightSnapshot.archiveSha256,
      archivedPathCount: preflightSnapshot.archivedPathCount,
      archivedPathProofs: preflightSnapshot.archivedPathProofs,
      cleanedArchivedPathCount: preflightSnapshot.cleanedArchivedPathCount,
      cleanedArchivedPaths: preflightSnapshot.cleanedArchivedPaths,
      baseRef: preflightSnapshot.baseRef,
      baseRefOid: preflightSnapshot.baseRefOid,
      dirtyFileCount: preflightSnapshot.dirtyFileCount,
      redundantDirtyFileCount: preflightSnapshot.redundantDirtyFileCount,
      redundantDirtyProofs: preflightSnapshot.redundantDirtyProofs,
      dirtySnapshotCommit: preflightSnapshot.dirtySnapshotCommit,
      dirtySnapshotRef: preflightSnapshot.dirtySnapshotRef,
      dirtySnapshotFileCount: preflightSnapshot.dirtySnapshotFileCount,
      dirtySnapshotFiles: preflightSnapshot.dirtySnapshotFiles,
      cleanedDirtyFiles: preflightSnapshot.cleanedDirtyFiles,
      cleanedDirtyFileCount: preflightSnapshot.cleanedDirtyFileCount,
...
export function createConfirmToken(preflight: Record<string, unknown>) {
  const material = {
    ...
    archivePath: preflight.archivePath ?? null,
    archiveSha256: preflight.archiveSha256 ?? null,
